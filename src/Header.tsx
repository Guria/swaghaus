  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
        ...
        <div className="flex gap-2 mt-6 sm:mt-0">
          <a href="https://github.com/JamesCowling/swaghaus">
            <button className="btn gap-2 flex flex-row">
              <svg:svg fill="currentColor" viewBox="0 0 24 24" className="h-6">
                <svg:path
                  fill-rule="evenodd"
      ...
      <div className="flex flex-col gap-2 max-w-prose text-sm">
        ...
        <p>
          Each component is fully dynamic and consistent with no manual
          synchronization logic. All queries in Convex are transactional, cached,
          and real-time.
        </p>
        <p>
